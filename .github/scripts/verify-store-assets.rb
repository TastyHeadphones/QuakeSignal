...
require_build16_screenshot_release_ready = false
...
ARGV.each do |argument|
  ...
  when "--require-build16-screenshot-release-ready"
    require_build16_screenshot_release_ready = true
...
begin
  AppleScreenshotReleaseSetValidator.new(
    ...
    require_release_ready: require_build16_screenshot_release_ready,
    expected_source_commit:
      require_build16_screenshot_release_ready ? expected_source_commit : nil,
  )

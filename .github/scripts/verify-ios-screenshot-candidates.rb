...
class IOSBuild8ScreenshotCandidateValidator
  MANIFEST_NAME = "screenshot-manifest-v1.1-build17.json"
  PROVENANCE_NAME = "screenshot-provenance-v1.1-build17.json"
  SCREENSHOT_ROOT = "screenshots-v1.1-build17"
  BUILD_EVIDENCE_ROOT = "screenshot-evidence-v1.1-build17"
  ...
  def validate_product!(product, label, require_simulator_fields:)
    ...
    require_equal!(product.fetch("build"), 15, "#{label} build")

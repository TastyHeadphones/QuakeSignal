...
module QuakeSignalIOSScreenshotBuildBinding
  ...
  def record(
    ...
    unless bundle_identifier == "com.quakesignal.app" && marketing_version == "1.1" && build_number == "16"
      raise Error, "built app identity differs from com.quakesignal.app 1.1 (16)"
    end

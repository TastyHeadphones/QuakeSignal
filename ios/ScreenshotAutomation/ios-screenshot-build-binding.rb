...
module QuakeSignalIOSScreenshotBuildBinding
  ...
  def record(
    ...
    unless bundle_identifier == "com.quakesignal.app" && marketing_version == "1.1" && build_number == "11"
      raise Error, "built app identity differs from com.quakesignal.app 1.1 (11)"
    end

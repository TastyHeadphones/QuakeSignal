...
module QuakeSignalIOSScreenshotBuildBinding
  ...
  def record(
    ...
    unless bundle_identifier == "com.quakesignal.app" && marketing_version == "1.1" && build_number == "8"
      raise Error, "built app identity differs from com.quakesignal.app 1.1 (8)"
    end

...
module QuakeSignalPlatformScreenshotPlan
  ...
  EXPECTED = {
    "tvos" => {
      manifest: "ios/AppStore/platforms/tvos/screenshot-manifest-v1.1-build17.json",
      product: {
        "platform" => "tvOS",
    ...
    "visionos" => {
      manifest: "ios/AppStore/platforms/visionos/screenshot-manifest-v1.1-build17.json",
      product: {
        "platform" => "visionOS",
        "marketingVersion" => "1.1",
        "build" => 17,
    ...
    "watchos" => {
      manifest: "ios/AppStore/platforms/watchos/screenshot-manifest-v1.1-build17.json",
      product: {

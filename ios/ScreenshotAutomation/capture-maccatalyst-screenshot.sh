...
manifest_file="ios/AppStore/platforms/maccatalyst/screenshot-manifest-v1.1-build15.json"
...
if [ "$bundle_identifier" != "com.quakesignal.app" ] || \
  ...
  echo "error: built app identity/version differs from the build-15 Catalyst contract" >&2
  exit 65
fi

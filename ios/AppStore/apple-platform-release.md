# Coordinated Apple platform release 1.1 (16)
...
node .github/scripts/verify-ios-release-contract.mjs --build-number 16
```
...
`QuakeSignal 1.1 (16) Native Release`. A single workflow is required because
